...
(function(){function a(k){var e=!1;if(window.gameStarted&&!window.gameOver){if(k.target!==k.currentTarget){document.getElementsByTagName("html")[0].classList.add("progressCursor");var l=k.target.id.substring(1,2),f=k.target.id.substring(2,3);if(0==c[l][f][0])k.target.style.backgroundColor="#4d88ff",c[l][f][0]=3,document.getElementById("s"+l+f).classList.add("miss"),window.currentColor="#4d88ff",z.play();else if(1==c[l][f][0]){k.target.style.backgroundColor="red";c[l][f][0]=2;document.getElementById("s"+
l+f).classList.add("hit");window.currentColor="red";A.play();h++;for(var g=0,d=$jscomp.makeIterator(u),b=d.next();!b.done;b=d.next())for(var b=b.value,q=$jscomp.makeIterator(b),m=q.next();!m.done;m=q.next()){var n=m.value;if(n[0]==l&&n[1]==f)for(n=$jscomp.makeIterator(b),m=n.next();!m.done;m=n.next()){var t=m.value;2==c[t[0]][t[1]][0]&&g++;if(g==b.length){window.currentColor="darkred";for(var r=$jscomp.makeIterator(b),m=r.next();!m.done;m=r.next())m=m.value,document.getElementById("s"+m[0]+m[1]).style.backgroundColor=
"darkred";document.getElementById(c[t[0]][t[1]][1]+"Sunk").classList.add("sunkText");e=!0;B.play()}}}if(17==h){document.getElementById("wintext").style.display="block";p.removeEventListener("click",a);window.gameOver=!0;window.modal("YOU WIN!!!",3E3);k=window.playerWinsOnLoad()+1;window.setCookie("playerwinsBattleship",k,.25);document.getElementById("playerWins").textContent="Player Wins: "+k;return}}else if(1<c[l][f][0]){window.modal("Can't Fire Here!",1400);return}}window.sleep(200).then(function(){return C(e)});
k.stopPropagation()}}function e(a){var k=[],l=D[r],f=window.randomIntFromInterval(1,2),g,d;do g=window.randomIntFromInterval(0,9);while(q.includes(g));do d=window.randomIntFromInterval(0,9);while(n.includes(d));var b=0;if(1==f)if(d>=a-1){for(f=0;f<a;f++)0==c[g][d-f][0]&&b++;if(b==a){for(b=0;b<a;b++)c[g][d-b][0]=1,c[g][d-b][1]=l,k.push([g,d-b]);q.push(g);n.push(d)}else e(a)}else{for(f=0;f<a;f++)0==c[g][d+f][0]&&b++;if(b==a){for(b=0;b<a;b++)c[g][d+b][0]=1,c[g][d+b][1]=l,k.push([g,d+b]);q.push(g);n.push(d)}else e(a)}else if(g>=
a-1){for(f=0;f<a;f++)0==c[g-f][d][0]&&b++;if(b==a){for(b=0;b<a;b++)c[g-b][d][0]=1,c[g-b][d][1]=l,k.push([g-b,d]);q.push(g);n.push(d)}else e(a)}else{for(f=0;f<a;f++)0==c[g+f][d][0]&&b++;if(b==a){for(b=0;b<a;b++)c[g+b][d][0]=1,c[g+b][d][1]=l,k.push([g+b,d]);q.push(g);n.push(d)}else e(a)}0!=k.length&&(u.push(k),r++)}var h=0,c=[],p=document.getElementById("gameboard"),A=new Audio("sounds/Hit Ship Sound.mp3"),z=new Audio("sounds/Miss Fire Sound.mp3"),B=new Audio("sounds/Ship Sunk Sound.mp3"),u=[],v="Thinking... Hmm... Finding... Tracking... Spotting... Hunting... Looking... Scanning... Seeking...".split(" "),
