...
h[a[0]][a[1]][0]=0;h[a[0]][a[1]][1]=""});L.splice(L.indexOf(a),1)}b.stopImmediatePropagation()},ba=["carrier","battleship","cruiser","submarine","destroyer"],oa=function(b){if(!y){var a=b.target.parentElement.id;document.getElementById(a).classList.contains("clicked")?(document.getElementById(a).classList.remove("clicked"),f=0):(ba.forEach(function(a){return document.getElementById(a).classList.remove("clicked")}),"carrier"!==a||M)?"battleship"!==a||N?"cruiser"!==a||O?"submarine"!==a||P?"destroyer"!==
...
a+c).classList.contains("blackBackground")&&""===h[a][c][1]){f===k.carrier?h[a][c][1]="carrier":f===k.battleship?h[a][c][1]="battleship":f===k.cruiser&&"cruiser"===r?h[a][c][1]="cruiser":f===k.submarine&&"submarine"===r?h[a][c][1]="submarine":f===k.destroyer&&(h[a][c][1]="destroyer");var e=document.getElementById("c"+a+c);e.addEventListener("click",W);e.addEventListener("mouseover",U);e.addEventListener("mouseleave",V);e.removeEventListener("click",B);e.classList.add("curserPointer");h[a][c][0]=1;
b.push([a,c])}f===k.carrier?(M=!0,l++,document.getElementById("carrier").classList.add("notDisplayed")):f===k.battleship?(N=!0,l++,document.getElementById("battleship").classList.add("notDisplayed")):f===k.cruiser?"cruiser"===r?(O=!0,l++,document.getElementById("cruiser").classList.add("notDisplayed")):"submarine"===r&&(P=!0,l++,document.getElementById("submarine").classList.add("notDisplayed")):f===k.destroyer&&(Q=!0,l++,document.getElementById("destroyer").classList.add("notDisplayed"));if(5===
l)for(document.getElementById("downArrow").classList.add("notDisplayed"),document.getElementById("leftList").classList.remove("notDisplayed"),document.getElementById("ships").classList.add("notDisplayed"),window.modal("All ships Placed!",1500),y=!0,window.gameStarted=!0,a=0;10>a;a++)for(c=0;10>c;c++)e=document.getElementById("c"+a+c),e.removeEventListener("mouseleave",aa),e.removeEventListener("click",W),e.removeEventListener("mouseover",U),e.removeEventListener("mouseleave",V),e.classList.remove("curserPointer");
f=0;L.push(b)}},t=function(b,a,c){return z(b,a)&&h[b][a][1]===c},qa=function(){if(G&&H&&I&&J&&K){document.getElementById("losstext").style.display="block";window.gameOver=!0;pa();window.sleep(1500).then(function(){return window.modal("HA HA! I WIN!",2E3)});var b=window.compWinsOnLoad()+1;window.setCookie("compwinsBattleship",b,.25);document.getElementById("compWins").textContent="Computer Wins: "+b}},ra=function(){var b=g,a=p;if("ver"===q){if(9>=b+1&&ca(b+1,a,!0))return;if(9<b+1||C(b+1,a)){for(var c=
1;10>c&&!(0>b-c||3===h[b-c][a][0]||4===h[b-c][a][0]);c++){if(w(b-c,a)){D(b-c,a);return}if(E(b-c,a)){F(b-c,a);return}}m=0;q=""}}if("hor"===q){if(9>=a+1&&ca(b,a+1,!1))return;if(9<a+1||C(b,a+1)){for(c=1;10>c&&!(0>a-c||3===h[b][a-c][0]||4===h[b][a-c][0]);c++){if(w(b,a-c)){D(b,a-c);return}if(E(b,a-c)){F(b,a-c);return}}m=0;q=""}}if(0===X){if(0===m&&""===q)if(9<b+1)m++;else if(x(b+1,a,"ver",1))return;if(1===m&&""===q)if(9<a+1)m++;else if(x(b,a+1,"hor",1))return}else{if(0===m&&""===q)if(9<a+1)m++;else if(x(b,
a+1,"hor",1))return;if(1===m&&""===q)if(9<b+1)m++;else if(x(b+1,a,"ver",1))return}if(2===m&&""===q)if(0>b-1)m++;else if(x(b-1,a,"ver",-1))return;3<=m&&""===q&&x(b,a-1,"hor",-1)},ca=function(b,a,c){return w(b,a)?(D(b,a),!0):E(b,a)?(F(b,a),c?g++:p++,!0):!1},x=function(b,a,c,e){if(w(b,a))return D(b,a),m++,!0;if(E(b,a))return F(b,a),q=c,m=0,"ver"===c?g+=e:p+=e,!0;m++;return!1},w=function(b,a){return z(b,a)&&0===h[b][a][0]},E=function(b,a){return z(b,a)&&1===h[b][a][0]},v=function(b,a){return z(b,a)&&
2===h[b][a][0]},C=function(b,a){return z(b,a)&&1<h[b][a][0]},F=function(b,a){document.getElementById("c"+b+a).classList.remove("blackBackground");document.getElementById("c"+b+a).classList.add("redBackground");h[b][a][0]=2;d++;S++},D=function(b,a){document.getElementById("c"+b+a).classList.remove("blackBackground");document.getElementById("c"+b+a).classList.add("missBackground");h[b][a][0]=3;S++},da=function(){var b,a;if(5>S||0===window.randomIntFromInterval(0,9)){do b=window.randomIntFromInterval(0,
8),a=window.randomIntFromInterval(0,8);while(0!=b%2&&0===a%2||0===b%2&&0!=a%2||[4,5,6].includes(b)||[4,5,6].includes(a))}else{a=$jscomp.makeIterator(sa());b=a.next().value;a=a.next().value;for(var c=0;10>c;c++)for(var e=0;10>e;e++)u[c][e]=0}g=b;p=a;w(b,a)?D(b,a):E(b,a)?F(b,a):C(b,a)&&da()},ta=function(){if(!window.gameOver&&window.gameStarted)if(y){0<d?ra():da();for(var b=0;10>b;b++)for(var a=0;10>a;a++)v(b,a)&&document.getElementById(h[b][a][1]+"Sunk_cpu").classList.add("hitText");for(var c=a=b=
0,e=0,g=0,n=0;10>n;n++)for(var f=0;10>f;f++)!G&&t(n,f,"carrier")&&v(n,f)?b++:!H&&t(n,f,"battleship")&&v(n,f)?a++:!I&&t(n,f,"cruiser")&&v(n,f)?c++:!J&&t(n,f,"submarine")&&v(n,f)?e++:!K&&t(n,f,"destroyer")&&v(n,f)&&g++;b===k.carrier&&(G=!0,A(5,"carrier"));a===k.battleship&&(H=!0,A(4,"battleship"));c===k.cruiser&&(I=!0,A(3,"cruiser"));e===k.submarine&&(J=!0,A(3,"submarine"));g===k.destroyer&&(K=!0,A(2,"destroyer"));qa()}else window.modal("Place all ships!",1400)},sa=function(){var b=[],a=0;G||b.push(k.carrier);
H||b.push(k.battleship);J||b.push(k.submarine);I||b.push(k.cruiser);K||b.push(k.destroyer);for(var c=0;c<b.length;c++){for(var e=0;10>e;e++)for(var d=0;d<10-b[c]+1;d++){for(var f=0;f<b[c];f++)C(e,d+f)||a++;if(a===b[c])for(a=0;a<b[c];a++)u[e][d+a]++;a=0}for(e=0;10>e;e++)for(d=0;d<10-b[c]+1;d++){for(f=0;f<b[c];f++)C(d+f,e)||a++;if(a===b[c])for(a=0;a<b[c];a++)u[d+a][e]++;a=0}}b=0;c=[];for(a=0;10>a;a++)for(e=0;10>e;e++)u[a][e]===b?c.push([a,e]):u[a][e]>b&&(b=u[a][e],c=[],c.push([a,e]));return c[window.randomIntFromInterval(0,
c.length-1)]},pa=function(){for(var b=0;10>b;b++)for(var a=0;10>a;a++)1===window.exportedGameBoard[b][a][0]&&window.addClassFromElementById("s"+b+a,"blackBackground")},ua=function(){window.addClassFromElementById("rotateArrow","rotateAnimation");window.removeClassFromElementById("rotateArrow","rotateBackAnimation")},va=function(){window.removeClassFromElementById("rotateArrow","rotateAnimation");window.addClassFromElementById("rotateArrow","rotateBackAnimation")};(function(){window.compMoveWindow=
ta;for(var b=0;10>b;b++){h.push([]);u.push([]);for(var a=0;10>a;a++){u[b].push(0);h[b].push([0,""]);var c=document.createElement("div");ea.appendChild(c);c.id="c"+a+b;var d=50*b+5;c.style.top=50*a+5+"px";c.style.left=d+"px";c.style.backgroundColor="#80aaff";c.addEventListener("mouseover",T);c.addEventListener("mouseleave",aa)}}la.forEach(function(a){return a.addEventListener("click",oa)});window.addEventListenerById("rotate","mouseover",ua);window.addEventListenerById("rotate","mouseleave",va);window.addEventListenerById("rotate",
"click",na);document.getElementById("compWins").textContent="Computer Wins: "+window.compWinsOnLoad();document.addEventListener("keydown",function(a){192===a.keyCode&&console.log(h)});"Y"===window.getCookie("darkMode")?window.setDarkMode():window.removeDarkMode()})()})();
