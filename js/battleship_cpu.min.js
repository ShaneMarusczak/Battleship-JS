...
"destroyer");var e=document.getElementById("c"+a+c);e.addEventListener("click",W);e.addEventListener("mouseover",U);e.addEventListener("mouseleave",V);e.removeEventListener("click",B);e.classList.add("curserPointer");h[a][c][0]=1;b.push([a,c])}f===k.carrier?(M=!0,l++,document.getElementById("carrier").classList.add("notDisplayed")):f===k.battleship?(N=!0,l++,document.getElementById("battleship").classList.add("notDisplayed")):f===k.cruiser?"cruiser"===r?(O=!0,l++,document.getElementById("cruiser").classList.add("notDisplayed")):
"submarine"===r&&(P=!0,l++,document.getElementById("submarine").classList.add("notDisplayed")):f===k.destroyer&&(Q=!0,l++,document.getElementById("destroyer").classList.add("notDisplayed"));if(5===l)for(document.getElementById("downArrow").classList.add("notDisplayed"),document.getElementById("leftList").classList.remove("notDisplayed"),document.getElementById("ships").classList.add("notDisplayed"),window.modal("All ships Placed!",1500),y=!0,window.gameStarted=!0,a=0;10>a;a++)for(c=0;10>c;c++)e=document.getElementById("c"+
