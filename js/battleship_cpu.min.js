...
0;a<b[c];a++)u[e+a][d]++;a=0}}b=0;c=[];for(a=0;10>a;a++)for(d=0;10>d;d++){if(6<L&&9>L){if(0!==a&&9!==a&&0!==d&&9!==d)continue;if(0!==d&&9!==d&&0!==a&&9!==a)continue}u[a][d]===b?c.push([a,d]):u[a][d]>b&&(b=u[a][d],c=[],c.push([a,d]))}return c[window.randomIntFromInterval(0,c.length-1)]},ra=function(){for(var b=0;10>b;b++)for(var a=0;10>a;a++)1===window.exportedGameBoard[b][a][0]&&window.addClassFromElementById("s"+b+a,"blackBackground")},wa=function(){window.addClassFromElementById("rotateArrow","rotateAnimation");
